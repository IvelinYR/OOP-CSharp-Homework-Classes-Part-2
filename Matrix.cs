    ...
    public class Matrix<T> 
    {
        ...
        public static Matrix<T> operator +(Matrix<T> m1, Matrix<T> m2)
        {
            ...
            for (int r = 0; r < result.matrix.GetLength(0); r++)
            {
                ...
                {
                    result[r, c] = (dynamic)m1[r, c] + m2[r, c];
                }
            }
            return result;
        }
        ...
        public static Matrix<T> operator *(Matrix<T> m1, Matrix<T> m2)
        {
            ...
            for (int r = 0; r < result.matrix.GetLength(0); r++)
            {
                for (int c = 0; c < result.matrix.GetLength(1); c++)
                {
                    ...
                    {
                        result[r, c] += (dynamic)m1[r, i] * m2[i, c];
                    }
        ...
        public override string ToString()
        {
            ...
            for (int rol = 0; rol < this.matrix.GetLength(0); rol++)
            {
                for (int cow = 0; cow < this.matrix.GetLength(1); cow++)
                {
                    sb.AppendFormat("{0, 3} ", this.matrix[rol, cow]);
                }
                sb.Append("\n");
            }
